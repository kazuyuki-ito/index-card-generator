...
export default {
    props: ['image', 'editCanvas', 'vertical', 'confirm', 'canvasId', 'proof', 'size', 'design'],
    data() {
        return {
            baseCanvas: null,
            canvasData: null,
    ...
    mounted(){
        if(this.size == "square") {
            this.canvasWidth = 525.5;
            this.canvasHeight = 525.5;
        ...
        if(this.size == "square") {
            ...
            let textSample1 = new fabric.Textbox('テキスト入力', {
                width: 1051,
                top: 100,
                left: 0,
                fontSize: 50,
            ...
            let textSample2 = new fabric.Textbox('テキスト入力', {
                width: 1051,
                top: 550,
                left: 0,
                fontSize: 90,
        ...
        this.confirm ? cv.isDrawingMode = false : cv.isDrawingMode = false
